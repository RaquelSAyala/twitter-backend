...
public class JwtValidator {
    ...
    public JwtValidator() {
        this.domain   = System.getenv("AUTH0_DOMAIN");   // e.g. dev-xxx.us.auth0.com
        this.audience = System.getenv("AUTH0_AUDIENCE"); // e.g. https://twitter-api/

        // Cache JWKS keys for 10 minutes to avoid repeated network calls
    ...
    /**
     * Validates the token and returns the decoded JWT on success.
     * Throws an exception if the token is invalid, expired, or has wrong audience.
     */
